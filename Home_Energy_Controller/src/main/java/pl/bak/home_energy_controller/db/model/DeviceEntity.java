...
public class DeviceEntity {
    ...
    public DeviceEntity(String id, String name, String category, String model, boolean online, Double currentPower, Double currentCurrent, Double currentVoltage, Double totalEnergy, LocalDateTime lastUpdated) {
        this.id = id;
        this.name = name;
